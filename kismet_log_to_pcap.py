...
try:
    ...
    print("kismet_log_to_kml requires dateutil; "
          "please install it either via your distribution")
...
npackets = 0
for result in packet_store.get_all(**query_args):
    if logf == None:
        if results.silent == None:
            print("Assuming dlt {} for all packets".format(query_args["dlt_gt"]))
